...
$$
\begin{aligned}
\left[\mathbf{q}_{t,1};\mathbf{q}_{t,2};\dots;\mathbf{q}_{t,n_h}\right] &= \mathbf{q}_t, \\
\left[\mathbf{k}_{t,1};\mathbf{k}_{t,2};\dots;\mathbf{k}_{t,n_h}\right] &= \mathbf{k}_t, \\
\left[\mathbf{v}_{t,1};\mathbf{v}_{t,2};\dots;\mathbf{v}_{t,n_h}\right] &= \mathbf{v}_t
\end{aligned}
\tag{4, 5, 6}
$$
...
\left[\mathbf{q}_{t,1}^R;\mathbf{q}_{t,2}^R;\dots;\mathbf{q}_{t,n_h}^R\right] &= \mathbf{q}_t^R = \mathrm{RoPE}\big(W^{QR} \mathbf{c}_t^Q\big), \\
...
$$
\begin{aligned}
\mathbf{q}_{t,i}^{R} &= \mathrm{RoPE}\left(W^{QR} \mathbf{c}_t^Q\right), \\
\mathbf{k}_{j}^{R} &= \mathrm{RoPE}\left(W^{KR} \mathbf{h}_j\right)
\end{aligned}
\tag{d}
$$
